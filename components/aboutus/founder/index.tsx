      ...
      <div className="sm:grid sm:grid-cols-3 gap-5">
        ...
        <div className="col-span-2 flex flex-col gap-4 bg-white p-6 rounded-lg">
          ...
          <p className="font-gilmer text-[1.125rem] sm:text-[1.25rem] text-[#001928] leading-[28px] sm:leading-[1.875rem] font-[400] tracking-[-2%] text-start">
            ...
            elementum ac dui sagittis adipiscing. Integer elementum gravida amet
            commodo. Mi vulputate orci donec eget id porttitor donec sit. Enim
            semper semper tellus sed vulputate.
          </p>
        </div>
      </div>
    </div>
