  ...
  return (
    <div className="flex flex-col gap-5 min-h-screen items-center justify-center w-full">
      ...
      <div className="flex flex-col gap-6 items-start w-full sm:w-[60%] h-full my-12">
        <p className="font-gilmer text-[1.125rem] sm:text-[2rem] text-[#001928] leading-[28px] sm:leading-[2.5rem] font-[400] tracking-[-2%] text-center">
          At Hiraeth Consultancy, we are architects of sustainable success.
          Specializing in Environmental, Social, and Governance (ESG) strategy,
          we empower businesses to transform ESG compliance into a competitive
          edge. By aligning companies with global sustainability standards and
          investor expectations, we craft bespoke ESG portfolios that drive
          funding opportunities, operational excellence, and long-term
          resilience.
        </p>
        <p className="font-gilmer text-[1.125rem] sm:text-[2rem] text-[#8A959C] leading-[28px] sm:leading-[2.5rem] font-[400] tracking-[-2%] text-center">
          Our expertise lies in bridging the gap between ethical business
          practices and financial performance, ensuring that ESG principles are
          not just a checklist but a catalyst for growth. Whether you’re a
      ...
      <div className="flex flex-col sm:flex-row sm:gap-8 gap-4 items-start w-full sm:w-[70%] mt-4 mb-12">
        <div className="bg-[#0083E7] py-10 px-10 sm:px-8 rounded-xl w-full sm:w-4/12 sm:h-[176px]">
          <p className="font-gilmer text-[1.125rem] sm:text-[1.5rem] text-white leading-[28px] sm:leading-[2rem] font-[700] tracking-[-2%]">
            Attract forward-thinking investors.
          </p>
        </div>
        <div className="bg-[#00CC66] py-10 px-10 sm:px-8 rounded-xl w-full sm:w-4/12 sm:h-[176px]">
          <p className="font-gilmer text-[1.125rem] sm:text-[1.5rem] text-white leading-[28px] sm:leading-[2rem] font-[700] tracking-[-2%]">
            Mitigate risks in an evolving regulatory landscape.
          </p>
        </div>
        <div className="bg-[#151515] py-10 px-10 sm:px-8 rounded-xl w-full sm:w-4/12 sm:h-[176px]">
          <p className="font-gilmer text-[1.125rem] sm:text-[1.5rem] text-white leading-[28px] sm:leading-[2rem] font-[700] tracking-[-2%]">
