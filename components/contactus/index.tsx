  ...
  return (
    ...
    >
      <div className=" flex flex-col gap-5 min-h-screen items-center justify-center w-full">
        ...
        <div className="sm:grid lg:grid-cols-2 gap-10 xl:gap-20 max-w-[10/12] px-6 mx-auto mt-10 mb-16">
          <div className="px-6 flex flex-col gap-8 bg-[#F0F6EB] sm:px-20 py-10 rounded-2xl">
            <div className="border-b border-b-[#334753] border-dashed pb-4 flex flex-col gap-3">
              <Icon name="address" />
              <span className="font-gilmer font-[700] text-primary text-[1.25rem]">
                Our business address
              </span>
              <p className="font-gilmer font-[400] text-[#334753] text-[1.25rem]">
          ...
          <div className="px-0 h-full mt-8 sm:mt-0">
            <CustomImage
              src="/contact.png"
              width={518}
              height={567}
